...
db.transaction(function (tx) {
	...
	db.transaction(function (tx) {
		...
		db.transaction(function (tx) {
			...
			db.transaction(function (tx) {
				tx.executeSql('insert into secret_question values(4,"wWhere you want to go for Holiday")');
			})

			db.transaction(function (tx) {
				tx.executeSql('insert into secret_question values(5,"Which is your favourite dish")');
			})
