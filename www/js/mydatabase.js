...
db.transaction(function (tx) {
    tx.executeSql('CREATE TABLE IF NOT EXISTS reports (username VARCHAR,headache VARCHAR,appointment_id integer,FOREIGN KEY (headache) REFERENCES MEDICINES(headache) )');
